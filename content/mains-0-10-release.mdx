...
Mains 0.10 is available for macOS (Apple Silicon and Intel), and open source under the MIT license at [github.com/mainsdotdev/mains](https://github.com/mainsdotdev/mains). The iOS app ships through TestFlight while it's in review.
