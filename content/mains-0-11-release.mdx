...
date: 2026-09-22
description: "Codex draws its answers instead of describing them, MCP Apps render inside the transcript, the in-app browser grew tabs and a device frame, ⌘⇧Space sends any window to the agent, and a request waiting on you now reaches the menu bar and your notifications."
author: "Mains Team"
