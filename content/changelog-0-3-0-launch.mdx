---
title: "Mains 0.4: our first public release"
date: 2026-07-09
description: "Mains 0.4 is the first public release of our open-source desktop app for running AI coding agents in managed, Git-backed workspaces."
author: "Mains Team"
...
# Mains 0.4: our first public release

Today marks a major milestone: **Mains 0.4 is our first public release** — and it is fully open source under the MIT license at [github.com/mainsdotdev/mains](https://github.com/mainsdotdev/mains).
...
Mains 0.4 is available for macOS (Apple Silicon and Intel).
