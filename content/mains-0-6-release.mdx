...
<div className="media-frame half glass-outline ">
  <video
    src="/changelog/0-6-edit-mode.mov"
    autoPlay
    loop
    muted
    playsInline
...
<div className="media-frame half glass-outline">
  <video
    src="/changelog/0-6-todo-bar.mov"
    autoPlay
    loop
    muted
    playsInline
...
![Consecutive image artifacts rendered as a compact tile gallery](/changelog/0-6-imagegallery.png)
