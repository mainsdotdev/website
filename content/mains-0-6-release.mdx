...
published: true
version: "0.6"
image: "/changelog/0-6-cover.jpeg"
---
...
<div className="media-frame half glass-outline brightness">
  <Video
    ...
    poster="/changelog/posters/0-6-subagent-panel.jpg"
    width="1088"
    height="1076"
...
<div className="media-frame half glass-outline brightness">
  <Video
    src="/changelog/0-6-git-action.mp4"
    poster="/changelog/posters/0-6-git-action.jpg"
    width="1088"
    height="1300"
    aria-label="Generating a commit message and opening a PR from the session panel"
  />
</div>
...
<div className="media-frame half glass-outline ">
  <Video
    src="/changelog/0-6-edit-mode.mp4"
    poster="/changelog/posters/0-6-edit-mode.jpg"
    width="1088"
    height="1012"
    aria-label="Editing a file in the workspace and watching the diff update"
  />
</div>
...
<div className="media-frame half glass-outline">
  <Video
    src="/changelog/0-6-todo-bar.mp4"
    poster="/changelog/posters/0-6-todo-bar.jpg"
    width="1088"
    height="914"
    aria-label="The task plan widget expanding from a pill into the full checklist"
  />
</div>
...
<Figure
  src="/changelog/0-6-imagegallery.png"
  alt="Consecutive image artifacts rendered as a compact tile gallery"
  width="2048"
  height="960"
/>
